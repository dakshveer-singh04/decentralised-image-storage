...
//           data: formData,
//           headers: {
//             pinata_api_key: `8d0da70fae0cfd2884e5`,
//             pinata_secret_api_key: `9dd76f067d0ff241cf25d278f8b6cce585dd082a69863063090314e6c8bbfdb8`,
...
//         alert("hash = ", ImgHash);
//         alert("Successfully Image Uploaded hash="+ImgHash);
      ...
      if (file) {
        try {
          ...
          const resFile = await axios({
            ...
            data: formData,
            headers: {
              pinata_api_key: `b03ed840bd6a05752c81`,
              pinata_secret_api_key: `74f1b25bb34abfd0058a25386ac1369e62eb2d37a88dc989aaacced8a898a06e`,
              "Content-Type": "multipart/form-data",
            },
          });
